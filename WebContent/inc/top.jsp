	...
	<ul class="nav navbar-top-links navbar-right">
		...
		<li class="dropdown"><a class="dropdown-toggle" style="color:white;"
			...
			<ul class="dropdown-menu dropdown-messages">
				<li><a href="#"> <span style="display: block;"> <strong>Trọng Tín</strong> <span class="pull-right text-muted"> <em>1 day ago</em>
						</span>
					</span> <span style="display: block;">Thông tin tuyển dụng nhân sự công ty tháng 7/2017</span>
				</a></li>
				<li class="divider"></li>
				<li><a href="#"> <span style="display: block;"> <strong>Quang Khôi</strong> <span class="pull-right text-muted"> <em>Yesterday</em>
						</span>
					</span> <span style="display: block;">Bảng báo giá vật liệu công ty Nagasaki</span>
				</a></li>
				<li class="divider"></li>
				<li><a href="#"> <span style="display: block;"> <strong>Quốc Khánh</strong> <span class="pull-right text-muted"> <em>Yesterday</em>
						</span>
					</span> <span style="display: block;">Quyết toán doanh thu công ty quý 1 + 2</span>
				</a></li>
				<li class="divider"></li>
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle" style="color:white;"
					...
					<div class="navbar-footer">
						<div class="navbar-footer-content">
							<div class="row">
								...
								<div class="col-md-6">
									<a href="<%=request.getContextPath()%>/Dangnhap/logout.htm"
